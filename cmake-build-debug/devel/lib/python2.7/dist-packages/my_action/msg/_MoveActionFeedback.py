...
"""autogenerated by genpy from my_action/MoveActionFeedback.msg. Do not edit."""
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "e5b2ff234dc663c40cf730159b9fcffd"
  _type = "my_action/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_action/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = my_action.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = my_action.msg.MoveFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.name = str[start:end].decode('utf-8')
      else:
        self.feedback.name = str[start:end]
      return self
