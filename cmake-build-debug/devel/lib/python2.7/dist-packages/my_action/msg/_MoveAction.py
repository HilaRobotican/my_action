...
"""autogenerated by genpy from my_action/MoveAction.msg. Do not edit."""
import sys
...
import genpy
import my_action.msg
import std_msgs.msg

class MoveAction(genpy.Message):
  _md5sum = "7fb950eebb7c3fdb98de6cf67052dcf5"
  _type = "my_action/MoveAction"
...
"""
  ...
  _slot_types = ['my_action/MoveActionGoal','my_action/MoveActionResult','my_action/MoveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = my_action.msg.MoveActionGoal()
      if self.action_result is None:
        self.action_result = my_action.msg.MoveActionResult()
      if self.action_feedback is None:
        self.action_feedback = my_action.msg.MoveActionFeedback()
    else:
      self.action_goal = my_action.msg.MoveActionGoal()
      self.action_result = my_action.msg.MoveActionResult()
      self.action_feedback = my_action.msg.MoveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.location_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.res
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.location_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.location_name = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.res = str[start:end].decode('utf-8')
      else:
        self.action_result.result.res = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.name = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.name = str[start:end]
      return self
