...
"""autogenerated by genpy from my_action/MoveActionResult.msg. Do not edit."""
import sys
...
class MoveActionResult(genpy.Message):
  _md5sum = "45d05b4bc67705fb63559b92fb813aca"
  _type = "my_action/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_action/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_action.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_action.msg.MoveResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.res = str[start:end].decode('utf-8')
      else:
        self.result.res = str[start:end]
      return self
