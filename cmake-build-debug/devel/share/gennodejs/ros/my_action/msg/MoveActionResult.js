...
class MoveActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = MoveResult.Resolve(msg.result)
    }
    else {
      resolved.result = new MoveResult()
    }
...
module.exports = MoveActionResult;
